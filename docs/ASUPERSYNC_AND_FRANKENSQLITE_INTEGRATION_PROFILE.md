...
| fastapi_rust | `531456a62e4484d74378c7f99b822eacae66043d` | Asupersync `0.3.9` | adopted gateway; its owned upstream must advance to the selected one-runtime constellation before FrankenGit integration |
