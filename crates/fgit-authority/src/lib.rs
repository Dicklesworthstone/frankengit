...
pub use crate::outcome::{
    ...
    head_selected_ref_state_absence_proof_async, indexed_outcome, indexed_outcome_async,
    initialize_repository, initialize_repository_async, interpret_indexed_outcome,
    next_batch_to_replay, outcome_index_proof, outcome_index_root, outcome_key, publish_decisions,
    publish_decisions_async, read_authority_head_body, read_authority_head_body_async,
    read_decision_batch_body, read_decision_batch_body_async, read_repository_configuration,
