...
pub use crate::outcome::{
    ...
    publish_decisions, publish_decisions_async, reconcile_outcome, replay_outcome, resolve_outcome,
    scan_batch_for, scan_for_existing_decisions, scan_for_existing_decisions_async,
};
