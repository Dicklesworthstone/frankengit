...
pub use crate::outcome::{
    ...
    RepositoryIncarnationConfiguration, TerminalOutcome, authority_head_identity, body_key_for_id,
    ...
    read_hidden_ref_policy, read_hidden_ref_policy_async, read_repository_configuration,
    read_repository_configuration_async, read_repository_incarnation_configuration,
    read_repository_incarnation_configuration_async, reconcile_outcome, record_creation_attempt,
    ...
    stage_latest_repository_incarnation_configuration_async, stage_repository_configuration,
    stage_repository_configuration_async, stage_repository_incarnation_configuration,
