...
const GIT_DAEMON_CAPABILITIES: &[u8] = b"allow-reachable-sha1-in-want shallow deepen-relative deepen-since deepen-not filter include-tag side-band-64k agent=frankengit-node";
