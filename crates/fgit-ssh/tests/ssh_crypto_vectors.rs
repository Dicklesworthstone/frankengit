...
use fgit_ssh::crypto::{
    CryptoError, Curve25519Kex, OpenSshChaCha20Poly1305,
    encode_ed25519_public_key, parse_ed25519_public_key, sign_ed25519, verify_ed25519,
};
...
fn test_rfc7748_curve25519_test_vectors() {
    ...
    let bob_priv = [
        0x5d, 0xab, 0x08, 0x7e, 0x62, 0x4a, 0x8a, 0x4b, 0x79, 0x47, 0x70, 0x1e, 0xbf, 0xb4,
        0x5d, 0x52, 0xd2, 0xf5, 0xb2, 0xf5, 0xe9, 0xda, 0x61, 0xf1, 0x6c, 0x42, 0xa9, 0xdb,
        0x36, 0x25, 0x70, 0x4b,
    ];
    let expected_bob_pub = [
        0xc6, 0xb8, 0xec, 0xf4, 0x90, 0xcf, 0x1b, 0xae, 0x17, 0x77, 0x9e, 0x9c, 0x07, 0x8a,
        0x5c, 0xd1, 0xa5, 0xee, 0x2b, 0x89, 0x27, 0xea, 0xc9, 0xf7, 0x4a, 0xf1, 0x26, 0x29,
        0x53, 0x32, 0xbc, 0x38,
    ];

    let expected_shared = [
        0x39, 0x57, 0x74, 0xa5, 0x47, 0x01, 0xbd, 0x94, 0x12, 0x67, 0x56, 0xd5, 0x12, 0x71,
        0x32, 0x66, 0x15, 0x90, 0x72, 0xcb, 0x52, 0xc3, 0xd3, 0x42, 0x4c, 0xa5, 0xe8, 0x8a,
        0xff, 0x8b, 0x44, 0x6e,
    ];
...
fn test_chacha20_poly1305_roundtrip_and_tampering() {
    ...
    for payload in &payloads {
        ...
        let decrypted = decryptor.decrypt_packet(&encrypted).expect("decryption failed");
