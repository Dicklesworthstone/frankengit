...
use fgit_chronicle::{
    ...
    OutcomeIndexCheckpointBody, PublicationBasis, PublicationPlan, ResultingRoots,
    activate_frozen_capsule, collect_cumulative_outcomes_from_authenticated_capsule_checkpoint,
