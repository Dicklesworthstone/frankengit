...
expected_failed='FG-000A-NEG-EQ FG-000A-NEG-NE FG-000A-NEG-EXIT FG-000A-NEG-CONT FG-000A-NEG-NCONT FG-000A-NEG-NCONTE FG-000A-NEG-MATCH FG-000A-NEG-MATCHE FG-000A-NEG-FILE FG-000A-NEG-NFILE FG-000A-NEG-NFILEE FG-000A-NEG-DIR FG-000A-NEG-DIG FG-000A-NEG-DIGM FG-000A-NEG-NDJ FG-000A-NEG-NDJM FG-000A-NEG-NDJE FG-000A-NEG-CMD FG-000A-NEG-FAIL'
...
fge_assert_eq FG-000A-ST-NEGCOUNT 19 "${#CASE_FAILED_IDS[@]}" \
  'nineteen assertion negatives are accounted for'
