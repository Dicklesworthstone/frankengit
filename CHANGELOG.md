...
**Scope and method:** this changelog is reconstructed from the complete git history of [`Dicklesworthstone/frankengit`](https://github.com/Dicklesworthstone/frankengit) (34 commits at the time of writing, 2026-08-19 through 2026-08-20). The project is pre-implementation: every entry describes architecture, contracts, registries, and verification tooling, not shipped software. There are no git tags and no GitHub Releases yet; the version spine below tracks **architecture document versions**, which are the only versioned artifact this repository has produced. Claim discipline applies here too: nothing in this file asserts implemented behavior.
